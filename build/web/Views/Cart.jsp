                        ...
                        <ul id="navbar" class="navbar-nav text-uppercase justify-content-start justify-content-lg-center align-items-start align-items-lg-center flex-grow-1">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu animate slide border">
                                    <li>
                                        <a href="about" class="dropdown-item fw-light">Giới thiệu<span
                                                class="badge bg-primary"></span></a>
                                    </li>
                                    <li>
                                        <a href="shop" class="dropdown-item fw-light">Sản phẩm<span
                                                class="badge bg-primary"></span></a>
                                    </li>

                                    <li>
                                        <a href="cart" class="dropdown-item active fw-light">Giỏ hàng <span
                                                class="badge bg-primary"></span></a>
                                    </li>
                                    <li>
                                        <a href="check" class="dropdown-item fw-light">Thanh toán <span
                                                class="badge bg-primary"></span></a>
                                    </li>
                                    <li>
                                        <a href="blog" class="dropdown-item fw-light">Tin tức <span
                                                class="badge bg-primary"></span></a>
                                    </li>

                                    <li>
                                        <a href="contact" class="dropdown-item fw-light">Liên hệ <span
                                                class="badge bg-primary"></span></a>
                                    </li>
                                </ul>
                            </li>
                                ...
                                <li class="cart-dropdown dropdown">
                                    ...
                                    <div class="dropdown-menu animate slide dropdown-menu-start dropdown-menu-lg-end p-3">
                                        ...
                                        <div class="d-flex flex-wrap justify-content-center">
                                            ...
                                            <a href="check" class="w-100 btn btn-primary" type="submit">Go to checkout</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                                ...
                                <div class="cart-info d-flex gap-2 flex-wrap align-items-center">
                                    <div class="col-lg-5">
                                        <div class="card-image">
                                            <img src="${pageContext.request.contextPath}/images/cart-item1.png" alt="cart-img" class="img-fluid border rounded-3">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-4 col-md-3">
                                <div class="cart-info d-flex gap-2 flex-wrap align-items-center">
                                    <div class="col-lg-5">
                                        <div class="card-image">
                                            <img src="${pageContext.request.contextPath}/images/cart-item2.png" alt="cart-img" class="img-fluid border rounded-3">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="card-detail">
