                    ...
                    <div class="offcanvas-body">
                        <ul id="navbar" class="navbar-nav text-uppercase justify-content-start justify-content-lg-center align-items-start align-items-lg-center flex-grow-1">
                          ...
                          class="badge bg-primary"></span></a>
                                    ...
                                    <li>
                                        <a href="cart" class="dropdown-item active fw-light">Cart <span
                          class="badge bg-primary"></span></a>
                                    </li>
                                    <li>
                                        <a href="check" class="dropdown-item fw-light">Checkout <span
                          class="badge bg-primary"></span></a>
                                    </li>
                                    <li>
                          ...
                          class="badge bg-primary"></span></a>
                                    ...
                                    <li>
                                        <a href="post" class="dropdown-item fw-light">Single Post <span
                          class="badge bg-primary"></span></a>
                                    </li>
                                    <li>
