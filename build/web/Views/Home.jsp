                        ...
                        <div class="row d-flex flex-column-reverse flex-md-row align-items-center">
                            ...
                            <div class="col-md-6 text-center">
                                <div class="image-holder">
                                    <img src="${pageContext.request.contextPath}/images/banner-image2.png" class="img-fluid" alt="banner">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide">
                    <div class="container">
                        <div class="row d-flex flex-column-reverse flex-md-row align-items-center">
                            ...
                            <div class="col-md-6 text-center">
                                <div class="image-holder">
                                    <img src="${pageContext.request.contextPath}/images/banner-image1.png" class="img-fluid" alt="banner">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide">
                    <div class="container">
                        <div class="row d-flex flex-column-reverse flex-md-row align-items-center">
                            ...
                            <div class="col-md-6 text-center">
                                <div class="image-holder">
                                    <img src="${pageContext.request.contextPath}/images/banner-image.png" class="img-fluid" alt="banner">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="card position-relative p-4 border rounded-3">
                            ...
                            <img src="${pageContext.request.contextPath}/images/product-item1.png" class="img-fluid shadow-sm" alt="product item">
                            <h6 class="mt-4 mb-0 fw-bold"><a href="single">House of Sky Breath</a></h6>
                    ...
                    <div class="swiper-slide">
                        <div class="card position-relative p-4 border rounded-3">
                            <img src="${pageContext.request.contextPath}/images/product-item2.png" class="img-fluid shadow-sm" alt="product item">
                            <h6 class="mt-4 mb-0 fw-bold"><a href="single">Heartland Stars</a></h6>
                            <div class="review-content d-flex">
                                <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                    ...
                    <div class="swiper-slide">
                        <div class="card position-relative p-4 border rounded-3">
                            <img src="${pageContext.request.contextPath}/images/product-item3.png" class="img-fluid shadow-sm" alt="product item">
                            <h6 class="mt-4 mb-0 fw-bold"><a href="single">Heavenly Bodies</a></h6>
                            <div class="review-content d-flex">
                                <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                    ...
                    <div class="swiper-slide">
                        <div class="card position-relative p-4 border rounded-3">
                            ...
                            <img src="${pageContext.request.contextPath}/images/product-item4.png" class="img-fluid shadow-sm" alt="product item">
                            <h6 class="mt-4 mb-0 fw-bold"><a href="single">His Saving Grace</a></h6>
                            <div class="review-content d-flex">
                                <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                    ...
                    <div class="swiper-slide">
                        <div class="card position-relative p-4 border rounded-3">
                            <img src="${pageContext.request.contextPath}/images/product-item5.png" class="img-fluid shadow-sm" alt="product item">
                            <h6 class="mt-4 mb-0 fw-bold"><a href="single">My Dearest Darkest</a></h6>
                            <div class="review-content d-flex">
                                <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                    ...
                    <div class="swiper-slide">
                        <div class="card position-relative p-4 border rounded-3">
                            <img src="${pageContext.request.contextPath}/images/product-item6.png" class="img-fluid shadow-sm" alt="product item">
                            <h6 class="mt-4 mb-0 fw-bold"><a href="single">The Story of Success</a></h6>
                            <div class="review-content d-flex">
                                <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
            ...
            <div class="row">
                        ...
                        <div class="items-lists">
                            <div class="item d-flex">
                                ...
                                <div class="item-content ms-3">
                                    <h6 class="mb-0 fw-bold"><a href="single">Echoes of the Ancients</a></h6>
                                    <div class="review-content d-flex">
                                        <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                          ...
                          <use xlink:href="#star-fill"></use>
                            ...
                            <div class="item d-flex">
                                <img src="${pageContext.request.contextPath}/images/product-item1.png" class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                                    <h6 class="mb-0 fw-bold"><a href="single">The Midnight Garden</a></h6>
                                    <div class="review-content d-flex">
                                        <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                                        <div class="rating text-warning d-flex align-items-center">
                                            <svg class="star star-fill">
                          ...
                          <use xlink:href="#star-fill"></use>
                            ...
                            <div class="item d-flex">
                                <img src="${pageContext.request.contextPath}/images/product-item3.png" class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                                    <h6 class="mb-0 fw-bold"><a href="single">Shadow of the Serpent</a></h6>
                                    <div class="review-content d-flex">
                                        <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                    ...
                    <div class="latest-items border rounded-3 p-4">
                        ...
                        <div class="items-lists">
                            <div class="item d-flex">
                                <img src="${pageContext.request.contextPath}/images/product-item4.png" class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                                    <h6 class="mb-0 fw-bold"><a href="single">Whispering Winds</a></h6>
                                    <div class="review-content d-flex">
                                        <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                                        <div class="rating text-warning d-flex align-items-center">
                                            <svg class="star star-fill">
                          ...
                          <use xlink:href="#star-fill"></use>
                            ...
                            <div class="item d-flex">
                                <img src="${pageContext.request.contextPath}/images/product-item5.png" class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                                    <h6 class="mb-0 fw-bold"><a href="single">The Forgotten Realm</a></h6>
                                    <div class="review-content d-flex">
                                        <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                                        <div class="rating text-warning d-flex align-items-center">
                                            <svg class="star star-fill">
                          ...
                          <use xlink:href="#star-fill"></use>
                            ...
                            <div class="item d-flex">
                                <img src="${pageContext.request.contextPath}/images/product-item6.png" class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                                    <h6 class="mb-0 fw-bold"><a href="single">Moonlit Secrets</a></h6>
                                    <div class="review-content d-flex">
                                        <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                                        <div class="rating text-warning d-flex align-items-center">
                                            <svg class="star star-fill">
                ...
                <div class="col-md-6 mb-4 mb-lg-0 col-lg-3">
                    <div class="best-reviewed border rounded-3 p-4">
                        ...
                        <div class="items-lists">
                            <div class="item d-flex">
                                <img src="${pageContext.request.contextPath}/images/product-item7.png" class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                                    <h6 class="mb-0 fw-bold"><a href="single">The Crystal Key</a></h6>
                                    <div class="review-content d-flex">
                                        <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                                        <div class="rating text-warning d-flex align-items-center">
                                            <svg class="star star-fill">
                          ...
                          <use xlink:href="#star-fill"></use>
                            ...
                            <hr class="gray-400">
                            <div class="item d-flex">
                                <img src="${pageContext.request.contextPath}/images/product-item8.png" class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                                    <h6 class="mb-0 fw-bold"><a href="single">Starlight Sonata</a></h6>
                                    <div class="review-content d-flex">
                                        <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                                        <div class="rating text-warning d-flex align-items-center">
                                            <svg class="star star-fill">
                          ...
                          <use xlink:href="#star-fill"></use>
                            ...
                            <hr>
                            <div class="item d-flex">
                                <img src="${pageContext.request.contextPath}/images/product-item9.png" class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                                    <h6 class="mb-0 fw-bold"><a href="single">Tales of the Enchanted Forest</a></h6>
                                    <div class="review-content d-flex">
                                        <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                                        <div class="rating text-warning d-flex align-items-center">
                                            <svg class="star star-fill">
                ...
                <div class="col-md-6 mb-4 mb-lg-0 col-lg-3">
                    <div class="on-sale border rounded-3 p-4">
                        ...
                        <div class="items-lists">
                            <div class="item d-flex">
                                <img src="${pageContext.request.contextPath}/images/product-item10.png" class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                                    <h6 class="mb-0 fw-bold"><a href="single">The Phoenix Chronicles</a></h6>
                                    <div class="review-content d-flex">
                                        <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                                        <div class="rating text-warning d-flex align-items-center">
                                            <svg class="star star-fill">
                      ...
                      $999</span>
                            ...
                            <hr class="gray-400">
                            <div class="item d-flex">
                                <img src="${pageContext.request.contextPath}/images/product-item11.png" class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                                    <h6 class="mb-0 fw-bold"><a href="single">Dreams of Avalon</a></h6>
                                    <div class="review-content d-flex">
                                        <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                                        <div class="rating text-warning d-flex align-items-center">
                                            <svg class="star star-fill">
                      ...
                      $410</span>
                            ...
                            <hr>
                            <div class="item d-flex">
                                <img src="${pageContext.request.contextPath}/images/product-item12.png" class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                                    <h6 class="mb-0 fw-bold"><a href="single">Legends of the Dragon Isles</a></h6>
                                    <div class="review-content d-flex">
                                        <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                                        <div class="rating text-warning d-flex align-items-center">
                                            <svg class="star star-fill">
