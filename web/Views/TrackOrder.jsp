                        ...
                        <p class="h5 text-dark">
                            ...
                            <span class="text-success
                                ...
                                <i class="text-secondary
                                   fa-solid fa-hashtag
                                   mr-1">
                                </i>Đơn hàng số: ${order.orderDetails[0].orderCId}
                            </span>
                        </p>
                    </div>
                        ...
                        <p class="font-weight-bold
                           ...
                           pt-3 ml-5">
                            ...
                            <span class="badge badge-pill
                                ...
                                <fmt:formatNumber value="${requestScope.order.totalPrice} " type="number" minFractionDigits="0" maxFractionDigits="0" /> VND</p>
