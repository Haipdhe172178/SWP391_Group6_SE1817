                    ...
                    <div class="d-flex gap-3 product-preview">
                        <div class="swiper thumb-swiper w-50">
                            <div class="swiper-wrapper d-flex flex-wrap gap-3 align-content-start">
                                <div class="swiper-slide bg-white">
                                    <img src="${pageContext.request.contextPath}/images/product-thumbnail-1.png" alt="product-thumb" class="img-fluid border rounded-3">
                                </div>
                                <div class="swiper-slide bg-white">
                                    <img src="${pageContext.request.contextPath}/images/product-thumbnail-2.png" alt="product-thumb" class="img-fluid border rounded-3">
                                </div>
                                <div class="swiper-slide bg-white">
                                    <img src="${pageContext.request.contextPath}/images/product-thumbnail-3.png" alt="product-thumb" class="img-fluid border rounded-3">
                                </div>
                            </div>
                        </div>
                        <div class="swiper large-swiper border rounded-3 overflow-hidden">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide bg-white">
                                    <img src="${pageContext.request.contextPath}/images/product-large-1.png" alt="single-product" class="img-fluid">
                                </div>
                                <div class="swiper-slide bg-white">
                                    <img src="${pageContext.request.contextPath}/images/product-large-2.png" alt="single-product" class="img-fluid">
                                </div>
                                <div class="swiper-slide bg-white">
                                    <img src="${pageContext.request.contextPath}/images/product-large-3.png" alt="single-product" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="card position-relative p-4 border rounded-3">
                            ...
                            <h6 class="mt-4 mb-0 fw-bold"><a href="single">Secrets of the Alchemist</a></h6>
