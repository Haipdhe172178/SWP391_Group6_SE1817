<%-- 
    Document   : Blog.jsp
    Created on : May 15, 2024, 10:54:49 PM
    Author     : huyca
--%>
                        ...
                        <div class="row post-contents">
                            <c:forEach var="news" items="${requestScope.listNews}">
                                <div class="col-lg-4 col-md-6 posts mb-5" >
                                    ...
                                    <h5 class="card-title mb-2 text-capitalize text-dark" style="font-weight: bold; font-size: 0.9em; color: #343a40; margin-bottom: 0.5em; text-transform: capitalize;"> <a href="#">${news.title}</a></h5>
                                    <p class="mb-2" style="display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient:vertical; overflow: hidden">${news.content} <span><a class="text-decoration-underline text-black-50" href="post">Read More</a></span> 
                                    </p>
                                </div>
                            </c:forEach>
                        </div>
