                ...
                <img src="${pageContext.request.contextPath}/images/main-logo.png" class="logo">
                    ...
                    <div class="offcanvas-body">
                        <ul id="navbar" class="navbar-nav text-uppercase justify-content-start justify-content-lg-center align-items-start align-items-lg-center flex-grow-1">
                            ...
                            <li class="nav-item">
                                <a class="nav-link me-4 active" href="shop">Shop</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="row product-content product-store">
                        <div class="col-lg-3 col-md-4 mb-4">
                            <div class="card position-relative p-4 border rounded-3">
                                ...
                                <h6 class="mt-4 mb-0 fw-bold"><a href="single">Blood on the Snow</a></h6>
                      ...
                      <span>
                        ...
                        <div class="col-lg-3 col-md-4 mb-4">
                            <div class="card position-relative p-4 border rounded-3">
                                ...
                                <h6 class="mt-4 mb-0 fw-bold"><a href="single">Story of Success</a></h6>
                                <div class="review-content d-flex">
                                    <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                      ...
                      <span>
                        ...
                        <div class="col-lg-3 col-md-4 mb-4">
                            <div class="card position-relative p-4 border rounded-3">
                                ...
                                <h6 class="mt-4 mb-0 fw-bold"><a href="single">City of the Dead</a></h6>
                                <div class="review-content d-flex">
                                    <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                      ...
                      <span>
                        ...
                        <div class="col-lg-3 col-md-4 mb-4">
                            <div class="card position-relative p-4 border rounded-3">
                                ...
                                <h6 class="mt-4 mb-0 fw-bold"><a href="single">The Dirty and Dead</a></h6>
                                <div class="review-content d-flex">
                                    <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                      ...
                      <span>
                        ...
                        <div class="col-lg-3 col-md-4 mb-4">
                            <div class="card position-relative p-4 border rounded-3">
                                ...
                                <h6 class="mt-4 mb-0 fw-bold"><a href="single">Life Flight</a></h6>
                                <div class="review-content d-flex">
                                    <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                      ...
                      <span>
                        ...
                        <div class="col-lg-3 col-md-4 mb-4">
                            <div class="card position-relative p-4 border rounded-3">
                                ...
                                <h6 class="mt-4 mb-0 fw-bold"><a href="single">The Colors of Life</a></h6>
                                <div class="review-content d-flex">
                                    <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                      ...
                      <span>
                        ...
                        <div class="col-lg-3 col-md-4 mb-4">
                            <div class="card position-relative p-4 border rounded-3">
                                ...
                                <h6 class="mt-4 mb-0 fw-bold"><a href="single">Mask of Death</a></h6>
                                <div class="review-content d-flex">
                                    <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
