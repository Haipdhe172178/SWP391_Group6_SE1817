                                    ...
                                    <div class="QA_section">
                                        <div class="white_box_tittle list_header">
                                            ...
                                            <div class="box_right d-flex lms_block">
                                                ...
                                                <div class="add_button ms-2">
                                                    <a href="adda" class="btn_1">Thêm Tác Giả</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <nav class="py-5" aria-label="Page navigation">
                                            <ul class="pagination justify-content-center gap-4">
                                                ...
                                                <c:if test="${tag > 1}">
                                                    <li class="page-item">
                                                        <a class="page-link" href="author?index=${tag - 1}${query}" aria-label="Previous">
                                                ...
                                                <c:forEach begin="${start}" end="${end}" var="i">
                                                    <li class="page-item ${tag == i ? 'active' : ''}">
                                                        <a class="page-link" href="author?index=${i}${query}">${i}</a>
                                                    </li>
                                                </c:forEach>
                                                ...
                                                <c:if test="${tag < endP}">
                                                    <li class="page-item">
                                                        <a class="page-link" href="author?index=${tag + 1}${query}" aria-label="Next">
