<%-- 
    Document   : header
    Created on : May 25, 2024, 6:43:23 PM
    Author     : Hai Pham
--%>
    ...
    <nav id="header-nav" class="navbar navbar-expand-lg py-3">
        <div class="container">
            <a class="navbar-brand" href="home">
                <img src="${pageContext.request.contextPath}/images/anh456.png" class="logo" style="width: 12rem; height: auto">
            </a>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
                ...
                <div class="offcanvas-body">
                    <ul id="navbar" class="navbar-nav text-uppercase justify-content-start justify-content-lg-center align-items-start align-items-lg-center flex-grow-1">
                        <li class="nav-item">
                            <a class="nav-link ${requestScope.active == 'home' ? 'active' : ''} me-4" name="index" href="${pageContext.request.contextPath}/home">Trang chủ</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ${requestScope.active == 'about' ? 'active' : ''} me-4" name="about" href="${pageContext.request.contextPath}/about">Giới thiệu</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ${requestScope.active == 'shop' ? 'active' : ''} me-4" name="shop" href="${pageContext.request.contextPath}/shop">Sản phẩm</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ${requestScope.active == 'news' ? 'active' : ''} me-4 " name="news" href="${pageContext.request.contextPath}/blog">Tin tức</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link me-4 dropdown-toggle" data-bs-toggle="dropdown" href="#" name="pages" role="button" aria-expanded="false">Trang</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link ${requestScope.active == 'contact' ? 'active' : ''} me-4" name="contact" href="${pageContext.request.contextPath}/contact">Liên hệ</a>
                        </li>
                        <li class="nav-item">
